...
#[Fillable(['project_id', 'task_id', 'agent_worker_id', 'role', 'status', 'attempt_number', 'codex_run_id', 'prompt_hash', 'result', 'commands', 'file_modifications', 'token_usage', 'log_path', 'live_output', 'exit_code', 'started_at', 'finished_at'])]
