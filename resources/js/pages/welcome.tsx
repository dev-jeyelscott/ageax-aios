...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="flex min-h-screen flex-col items-center bg-[#0a0a0a] p-6 text-[#EDEDEC] lg:justify-center lg:p-8">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-[#161615] p-6 pb-12 text-[13px] leading-[20px] text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_#fffaed2d] lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
                            ...
                            <p className="mb-2 text-[#A1A09A]">
                                Laravel has an incredibly rich ecosystem.
                                <br />
                                We suggest starting with the following.
                            </p>
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#3E3E3A]">
                                    <span className="relative bg-[#161615] py-1">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#3E3E3A] bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]">
                                    ...
                                    <span>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-[#FF4433] underline underline-offset-4"
                                        >
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#3E3E3A]">
                                    <span className="relative bg-[#161615] py-1">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#3E3E3A] bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#3E3E3A]" />
                                        </span>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-[#eeeeec] bg-[#eeeeec] px-5 py-1.5 text-sm leading-normal text-[#1C1C1A] hover:border-white hover:bg-white"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#1D0002] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg">
                            {/* Laravel Logo */}
                            <svg
                                className="w-full max-w-none translate-y-0 text-[#F61500] opacity-100 transition-all duration-750 starting:opacity-0 motion-safe:starting:translate-y-6"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            {/* 13 */}
                            <svg
                                className="relative -mt-[6.6rem] -ml-8 w-[438px] max-w-none [--stroke-color:#FF750F] lg:ml-0"
                                viewBox="0 0 440 392"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g className="text-black opacity-100 mix-blend-normal transition-all delay-300 duration-750 starting:opacity-0">
                                    <mask
                                        id="path-1-mask"
                                ...
                                <g className="text-[#4B0600] opacity-100 transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[26px]">
                                    <mask
                                        id="path-2-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="25.3357"
                                ...
                                <g className="text-[#391800] opacity-100 mix-blend-hard-light transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[51px]">
                                    <mask
                                        id="path-3-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="51"
                                ...
                                <g className="text-[#733000] opacity-100 mix-blend-normal transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[78px]">
                                    <mask
                                        id="path-4-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="76.6643"
                                ...
                                <g className="text-[#4B0600] opacity-100 mix-blend-hard-light transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[102px]">
                                    <mask
                                        id="path-5-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="102.329"
                            ...
                            <div className="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_#fffaed2d] lg:rounded-t-none lg:rounded-r-lg"></div>
                        </div>
                    </main>
                </div>
