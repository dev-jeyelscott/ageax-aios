...
use App\Http\Controllers\VoiceSpeechController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post(
        'voice/speech',
        VoiceSpeechController::class,
    )->name('voice.speech.store');
    ...
    Route::get('agents', [GlobalAgentController::class, 'index'])
        ->name('agents.index');
    Route::get('agents/{agent}', [GlobalAgentController::class, 'show'])
        ->name('agents.show');
    Route::patch('agents/{agent}', [GlobalAgentController::class, 'update'])
        ->name('agents.update');
    Route::post('agents/{agent}/invoke', [GlobalAgentController::class, 'invoke'])
        ->name('agents.invoke');
    Route::get(
    ...
    Route::get(
        'ticket-operations',
        [TicketOperationsController::class, 'index'],
    )->name('ticket-operations.index');
    Route::get(
        'ticket-operations/{ticket}',
        [TicketOperationsController::class, 'show'],
    )->name('ticket-operations.show');

    Route::get(
        'harness-scorecards',
        [HarnessScorecardController::class, 'index'],
    )->name('harness-scorecards.index');
    ...
    Route::get(
        ...
        [ProjectController::class, 'showTask'],
    )->scopeBindings()->name('projects.tasks.show');

    Route::get(
        'projects/{project}/agent-runs/{run}',
        [ProjectController::class, 'showAgentRun'],
    )->scopeBindings()->name('projects.agent-runs.show');

    Route::post(
        'projects/{project}/project-manager-messages',
        [ProjectController::class, 'storeProjectManagerMessage'],
    )->name('projects.project-manager-messages.store');

    Route::post(
        'projects/{project}/tasks/{task}/operator-messages',
        [ProjectController::class, 'storeOperatorMessage'],
    ...
    )->scopeBindings()->name('projects.tickets.show');

    Route::post(
        'projects/{project}/tickets/{ticket}/messages',
        [TicketController::class, 'storeMessage'],
    )->scopeBindings()->name('projects.tickets.messages.store');
    ...
    Route::post(
        'projects/{project}/knowledge-improvements/{candidate}/promote',
        [KnowledgeImprovementController::class, 'promote'],
    )->name('projects.knowledge-improvements.promote');

    Route::post(
        'projects/{project}/agents',
        [AgentController::class, 'store'],
    )->name('projects.agents.store');

    Route::patch(
        'projects/{project}/agents/{agent}',
        [AgentController::class, 'update'],
    )->scopeBindings()->name('projects.agents.update');

    Route::post(
        'projects/{project}/agents/{agent}/skills',
        [AgentController::class, 'assignSkill'],
    )->scopeBindings()->name('projects.agents.skills.store');

    Route::patch(
        'projects/{project}/agents/{agent}/skills',
        [AgentController::class, 'reorderSkills'],
    )->scopeBindings()->name('projects.agents.skills.reorder');

    Route::delete(
        'projects/{project}/agents/{agent}/skills/{skill}',
        [AgentController::class, 'unassignSkill'],
    )->scopeBindings()->name('projects.agents.skills.destroy');

    Route::patch(
        'projects/{project}/agents/{agent}/worker',
        [AgentController::class, 'bindWorker'],
    )->scopeBindings()->name('projects.agents.worker.update');
    ...
    )->scopeBindings()->name('projects.skills.update');

    Route::delete(
        'projects/{project}/skills/{skill}',
        [SkillController::class, 'destroy'],
    )->scopeBindings()->name('projects.skills.destroy');
});
